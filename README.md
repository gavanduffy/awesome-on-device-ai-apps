...
| App | What it does | Model | Platforms | Try it |
| :-- | :-- | :-- | :-- | :-- |
| [**NeuTTS Nano**](apps/NeuTTSNanoApp) | On-device text-to-speech with voice cloning, via a three-stage NeuTTS Nano pipeline. | `NeuTTS Nano` | `iOS` | [Model ↗](https://mlange.zetic.ai/p/Gavanduffy/neutts-nano) |
